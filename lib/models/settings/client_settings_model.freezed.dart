...
mixin _$ClientSettingsModel implements DiagnosticableTreeMixin {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    properties
      ...
      ..add(DiagnosticsProperty('showFoldersInLibrary', showFoldersInLibrary))
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'ClientSettingsModel(syncPath: $syncPath, position: $position, size: $size, timeOut: $timeOut, nextUpDateCutoff: $nextUpDateCutoff, themeMode: $themeMode, themeColor: $themeColor, deriveColorsFromItem: $deriveColorsFromItem, amoledBlack: $amoledBlack, blurPlaceHolders: $blurPlaceHolders, blurUpcomingEpisodes: $blurUpcomingEpisodes, selectedLocale: $selectedLocale, enableMediaKeys: $enableMediaKeys, posterSize: $posterSize, pinchPosterZoom: $pinchPosterZoom, mouseDragSupport: $mouseDragSupport, requireWifi: $requireWifi, showAllCollectionTypes: $showAllCollectionTypes, maxConcurrentDownloads: $maxConcurrentDownloads, schemeVariant: $schemeVariant, backgroundImage: $backgroundImage, checkForUpdates: $checkForUpdates, usePosterForLibrary: $usePosterForLibrary, useSystemIME: $useSystemIME, showFoldersInLibrary: $showFoldersInLibrary, lastViewedUpdate: $lastViewedUpdate, libraryPageSize: $libraryPageSize, shortcuts: $shortcuts)';
  }
}
...
class _$ClientSettingsModelCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    Object? showFoldersInLibrary = null,
    ...
    return _then(_self.copyWith(
      ...
      useSystemIME: null == useSystemIME
          ...
          : useSystemIME // ignore: cast_nullable_to_non_nullable
              as bool,
      showFoldersInLibrary: null == showFoldersInLibrary
          ? _self.showFoldersInLibrary
          : showFoldersInLibrary // ignore: cast_nullable_to_non_nullable
              as bool,
...
class _ClientSettingsModel extends ClientSettingsModel
  ...
  _ClientSettingsModel(
      ...
      this.showFoldersInLibrary = false,
  ...
  @override
  @JsonKey()
  final bool showFoldersInLibrary;
  @override
